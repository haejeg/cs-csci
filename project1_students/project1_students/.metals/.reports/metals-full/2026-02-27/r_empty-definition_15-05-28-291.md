error id: file:///C:/Users/haeje/Downloads/project1_students/project1_students/src/test/scala/edu/colorado/csci3155/project1/StackMachineTest.scala:StackMachineEmulator.
file:///C:/Users/haeje/Downloads/project1_students/project1_students/src/test/scala/edu/colorado/csci3155/project1/StackMachineTest.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -Conversions.StackMachineEmulator.
	 -StackMachineEmulator.
	 -scala/Predef.StackMachineEmulator.
offset: 787
uri: file:///C:/Users/haeje/Downloads/project1_students/project1_students/src/test/scala/edu/colorado/csci3155/project1/StackMachineTest.scala
text:
```scala
...
class StackMachineTest extends AnyFunSuite with BeforeAndAfterAll  {
    ...
    test("stack machine test 1") {
        ...
        val (res, _) = Stac@@kMachineEmulator.emulateStackMachine(lst1)
